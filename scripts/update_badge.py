...
def main() -> None:
    ...
    repo_name = os.environ["GITHUB_REPOSITORY"]  # needs full repo-name with username e.g. vroomfondel/arley

    history_filename = "arley_clone_history.json"
    badge_filename = "arley_clone_count.json"
